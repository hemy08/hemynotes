...
- 左侧native-tab
    ...
    - 增加绘图功能
    - 增加mermaid功能
- （<span style="font-size: 12pt; color: #FF0000; background-color: #FFFFFF; font-family='Arial';"><u><b>已解决</b></u></span>
）渲染区域中的连接，点击之后未跳转到浏览器页面，直接在app中打开了页面，而且无返回功能，在使用鼠标左侧后退键后退时，app返回到了刚打开的状态
