...
graph TB
    subgraph "内存层"
        A["MemTable (活跃)"] --"→"--> B["Immutable MemTable"]
    end
    
    B --"↓ Flush"--> sub_disk
    subgraph "磁盘层"
        C["Level 0: [SSTable1] [SSTable2] [SSTable3]"]
        D["Level 1: [SSTable4] [SSTable5]"]
        E["Level 2: [SSTable6] [SSTable7] [SSTable8] [SSTable9]"]
        F["..."]
    end
    
    style A fill:#4CAF50,color:#fff
    style B fill:#FF9800,color:#fff
    style sub_disk fill:#FFF3E0
```
