...
graph LR
    subgraph "单链表结构示意"
        H["head"] --> N1["节点1<br/>data | next"]
        N1 -->|"next"| N2["节点2<br/>data | next"]
        N2 -->|"next"| N3["节点3<br/>data | next"]
        N3 -->|"next"| N4["节点4<br/>data | next"]
        N4 -->|"next"| N["NULL"]
    end
...
graph LR
    subgraph "双链表结构示意"
        N["NULL"] <-.-> N1["节点1<br/>prev | data | next"]
        N1 <-.-> N2["节点2<br/>prev | data | next"]
        N2 <-.-> N3["节点3<br/>prev | data | next"]
        N3 <-.-> N4["节点4<br/>prev | data | next"]
        N4 -.-> T["NULL"]
        H["head"] --> N1
        T2["tail"] --> N4
    end
...
graph LR
    subgraph "循环链表结构示意"
        N1["节点1<br/>data | next"] --> N2["节点2<br/>data | next"]
        N2 --> N3["节点3<br/>data | next"]
        N3 --> N4["节点4<br/>data | next"]
        N4 -->|"next"| N1
    end
